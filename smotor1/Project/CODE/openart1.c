		...
		if(ART1_mode==1)
		{
			...
			else if(rxstate == 1)
			{
				if(ART1_uart_rx_buffer == 'Y')//接收到帧尾
				{
					...
					ART1_POINT_X[3] = ART1_dat[2];
					ART1_POINT_Y[3] = ART1_dat[3];
					ART1_POINT_X[1] = ART1_dat[4];
					ART1_POINT_Y[1] = ART1_dat[5];
					ART1_POINT_X[2] = ART1_dat[6];
					ART1_POINT_Y[2] = ART1_dat[7];
